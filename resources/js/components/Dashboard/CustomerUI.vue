    ...
    <div class="mt-20 mb-20">
        ...
        <div class="max-w-lg mx-auto p-6 text-center">
            <h2 class="text-2xl text-[#232850]">
                {{ customerData.client_name }}
            </h2>
            <p
                class="text-sm text-gray-600"
                v-if="this.customerData.client_total_gig_price > 500"
            >
                Gold Star Customer
            </p>
            ...
            <i
                class="fas fa-star text-yellow-500 text-2xl mt-2"
                v-if="this.customerData.client_total_gig_price > 500"
            ></i>
        </div>
        ...
        <div class="max-w-lg mx-auto space-y-4 p-6">
            ...
            >
                <div class="flex items-center space-x-3">
                    ...
                    <div class="w-12 h-12 flex justify-center items-center">
                        <i
                            class="fas fa-phone text-gray-500 text-[32px] flex-shrink-0 leading-none"
                        ></i>
                    </div>
                    <div>
                        <p class="text-sm font-medium text-[#666666FF]">
                            Contact {{ customerData.client_name }} NOW
                        </p>
                        <a
            ...
            >
                <div class="flex items-center space-x-3">
                    ...
                    <div class="w-12 h-12 flex justify-center items-center">
                        <i
                            class="fas fa-id-card text-gray-500 text-[32px] flex-shrink-0 leading-none"
                        ></i>
                    </div>
                    <div>
                        <p class="text-sm font-medium text-[#666666FF]">
            ...
            >
                <div class="flex items-center space-x-3">
                    ...
                    <div class="w-12 h-12 flex justify-center items-center">
                        <i
                            class="fas fa-map-marker-alt text-gray-500 text-[32px] flex-shrink-0 leading-none"
                        ></i>
                    </div>
                    <div>
                        <p class="text-sm font-medium text-[#666666FF]">
        ...
        <div class="max-w-lg mx-auto p-6">
            ...
            <div class="space-y-4 mt-3">
                <div
                    v-if="customerData.gigs && customerData.gigs.length"
                    class="space-y-4"
                >
                    <div
                        v-for="gig in customerData.gigs"
                        :key="gig.gig_id"
                        class="bg-white shadow-md rounded-lg p-4 cursor-pointer"
                        @click="goToGig(gig.gig_id)"
                    >
                        <p class="text-sm font-medium text-[#666666FF]">
                            Gig#
                            {{
        ...
        <div class="max-w-lg mx-auto p-6">
            ...
            <div class="space-y-4 mt-3">
                <div
                    v-if="customerData.machines && customerData.machines.length"
                    class="space-y-4"
                >
                    <div
                        v-for="machine in customerData.machines"
                        :key="machine.machine_id"
                        class="bg-white shadow-md rounded-lg p-4 cursor-pointer"
                        @click="goToModel(machine.machine_id)"
                    >
                        <p class="text-sm font-medium text-[#666666FF]">
                        ...
                        <p
                            v-if="machine.extra_field1"
                            class="text-xs text-gray-500"
                        >
                            {{ machine.extra_field1 }}
                        </p>
                        <p
                            v-if="machine.extra_field2"
                            class="text-xs text-gray-500"
                        >

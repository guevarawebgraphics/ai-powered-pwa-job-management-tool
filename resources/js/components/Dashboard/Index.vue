    ...
    <div class="mt-20 mb-20">
        ...
        <div class="flex flex-col items-center p-6">
            ...
            <div class="mt-3 text-center">
                <div class="relative inline-block">
                    <h2 class="text-lg text-[#232850FF]">Full Name</h2>
                    <!-- Edit Icon -->
        ...
        <div class="max-w-lg mx-auto p-6">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl text-[#232850FF]">June, 12</h2>
            ...
            <div class="grid grid-cols-2 gap-3">
                <div
                    ...
                    <div class="flex items-center space-x-2">
                        <i class="fas fa-headphones-simple text-lg text-gray-700"></i>
                        <span class="text-xl font-medium">DAX</span>
                    </div>
                ...
                <div
                    ...
                    <p class="text-sm text-gray-500">Jobs Booked Today</p>
                </div>
        ...
        <div class="max-w-lg mx-auto p-6">
            <h2 class="text-xl text-[#232850FF]">Latest Updates</h2>
        ...
        <!-- Latest Updates Section -->
        <div class="max-w-lg mx-auto p-6">
            <h2 class="text-xl font-medium text-[#232850FF]">Earn While you Learn</h2>

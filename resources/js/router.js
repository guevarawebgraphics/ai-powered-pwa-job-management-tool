...
const routes = [
    ...
    { path: '/gig-repair', component: GigRepair, meta: { requiresAuth: true, requiresVerification: true } },
    { path: '/model', component: ModelPage, meta: { requiresAuth: true, requiresVerification: true } },
    { path: '/customer', component: Customer, meta: { requiresAuth: true, requiresVerification: true } },
];
